...
/// @brief Models a triangle with sides @c a, @c b, and @c.
class Triangle
{
public:
    /// @brief Construct triangle with sides @c a, @c b, and @c c.
    Triangle(double a, double b, double c);

    /// @brief Construct triangle with sides @c a and @c b, and angle @c C.
    static Triangle with_a_b_C(double a, double b, const Angle & C);

    /// @brief Construct triangle with angles @c A and @c B, and side @c C.
    static Triangle with_A_B_c(const Angle & A, const Angle & B, double c);

    /// @brief Split triangle into right-angled triangle.
