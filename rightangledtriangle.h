...
/// @brief Models a right-angled triangle.
...
{
public:
    /// @brief Construct right-angled triangle with sides @c a, @c b, and @c c.
    static RightAngledTriangle with_a_b_c(double a, double b, double c);

    /// @brief Construct right-angled triangle with sides @c a and @c b.
    static RightAngledTriangle with_a_b(double a, double b);

    /// @brief Construct right-angled triangle with sides @c a and @c c.
    static RightAngledTriangle with_a_c(double a, double c);

    /// @brief Construct right-angled triangle with angle @c A and hypotenuse @c c.
    static RightAngledTriangle with_A_c(const Angle & A, double c);

    /// @brief Construct right-angled triangle from existing triangle @c r, with new opposite side @c a.
    static RightAngledTriangle with_a(const RightAngledTriangle &, double a);

    /// @brief Construct right-angled triangle from existing triangle @c r, with new adjacent side @c b.
    static RightAngledTriangle with_b(const RightAngledTriangle &, double b);

    /// @brief Construct right-angled triangle from existing triangle @c r, with new hypotenuse @c c.
